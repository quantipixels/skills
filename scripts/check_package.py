...
def check(root: Path) -> list[str]:
    ...
    for folder in ("skills", "agents", "docs", "proof"):
...
def main() -> int:
    ...
    if errors:
        ...
        return 1
    print("PASS: skill identities, local link paths, plugin paths and invocation policy consistency")
    print("Not checked: host invocation, external links/anchors, model behavior or human comprehension")
    return 0
