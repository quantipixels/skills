...
Use `glab auth status --hostname <host>` and paginated `glab api`. Read MR pipelines, pipeline jobs, job traces, approvals, and discussions. Preserve allowed-failure and manual job semantics.
