...
const PROJECT_GENERATE_TOKENS_SCRIPT = 'eto-apere/scripts/generate-tokens.cjs';
const BUNDLED_GENERATE_TOKENS_SCRIPT = path.resolve(__dirname, '../../eto-apere/scripts/generate-tokens.cjs');
...
function updateDesignTokens(tokens, colors) {
  // Update brand name
  const brandName = tokens.brand || 'Brand';
