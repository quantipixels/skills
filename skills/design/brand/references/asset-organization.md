...
| campaign | kebab-case | Yes* | product-launch, q1-promo, evergreen |
...
### Examples
```
banner_product-launch_hero-image_20251209_16-9.png
...
```json
{
  ...
  "type": "banner",
  "path": "assets/banners/landing-pages/banner_product-launch_hero-image_20251209.png",
...
```json
{
  "version": 2,
  "previousVersion": 1,
  "path": "assets/banners/landing-pages/banner_product-launch_hero-image_20251209_v2.png",
...
grep -l "product-launch" .assets/manifest.json
```
