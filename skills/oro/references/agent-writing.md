...
When retaining a consequential instruction change depends on a controlled comparison, read [evaluate instructions](agent-evaluation.md). Routine editorial checks stay here.
