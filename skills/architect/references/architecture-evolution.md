...
Sources: [DORA architecture outcomes](https://dora.dev/capabilities/loosely-coupled-teams/), [DevEx framework](https://www.michaelagreiler.com/wp-content/uploads/2024/06/DevEx-WhatDrivesProductivity.pdf), [Google API compatibility](https://google.aip.dev/180), [AX concepts](https://agentexperience.ax/concepts/getting-started/), [Cargo resolved metadata](https://doc.rust-lang.org/cargo/commands/cargo-metadata.html), [ArchUnit incremental rules](https://www.archunit.org/userguide/html/000_Index.html#_freezing_arch_rules). These inform the method; their product conventions and organization-wide programs are not requirements.

Discovery: [adding-dependencies](https://github.com/riekelt/principal-engineer/blob/e67b7af9ac741945246012023ade5c2fee1222fa/plugins/principal-engineer/skills/adding-dependencies/SKILL.md) and [repo-architecture](https://github.com/objectivlabs/reposkillopt/blob/45eaff0ce37175f6589fb90a667e5ead0ba4d1af/skills/repo-architecture/SKILL.md). Fixed approval ladders, prerequisite repository maps and mandatory report pipelines are not adopted.
