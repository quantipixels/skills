...
Reject generic style, unrelated debt, deterministic-tool noise, unsupported speculation, and findings without a candidate-caused or candidate-dependent mechanism. Keep maintainability-only concerns in QP Code Review's maintainability mode.
