...
Delegate independent workstream decomposition or dependency checks to subagents when useful. Integrate their proposed tickets and evidence into one coherent dependency graph.
...
Use [behavior contract](behavior-contract.md) as needed. Preserve the governing contract’s identity and requirements when decomposing it.
