...
Show variants together only when simultaneous comparison is the purpose. When each page or view must show one design, give each variant a direct link plus persistent previous, next, and index links:
