...
| A host already supplies jQuery or a required maintained plugin uses it | Reuse that capability | A DOM wrapper; jQuery core alone is not a complete accessible widget. |
