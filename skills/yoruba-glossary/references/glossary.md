...
Track only task-added, corrected, rejected or unsettled terms as `English | Yorùbá | proposed|confirmed|rejected|unsettled | optional usage note`. A task-local decision creates no durable-write authority.
