...
4. A selected implementation and its regression proof belong to `alaga`; the experiment's keep/revert judgment stays with `alaga`. Reuse candidate code and valid proof rather than commissioning the same implementation or measurement twice.
