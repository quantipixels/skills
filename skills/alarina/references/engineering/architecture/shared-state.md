...
Before adding synchronization, ask whether independent ownership can eliminate shared mutation. Separate independently owned facts only when their consistency and read contract permit it; preserve genuinely shared invariants. When sharing remains necessary, use an enforced ownership or concurrency mechanism, not a prose convention.
