...
- **Branch defect:** reproduce or directly trace the failure to the changed behavior. Use [alaga-deliver](../../../commands/alaga-deliver.md) for the correction.
...
- **Unclear cause:** make a bounded diagnosis attempt, then report decisive missing evidence and the next action. Use [alaga-diagnose](../../../commands/alaga-diagnose.md) as needed.
