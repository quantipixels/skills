...
Return the URL, exact published candidate, actual provider state, decisive evidence, risk/recovery and material limits. Use [stewardship](wo-pr.md) only when that outcome is also requested.
