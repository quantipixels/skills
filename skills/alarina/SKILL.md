...
- **Missing evidence/tool capability** — `iwadi` for substantial current research; `irinse` for companion-tool choice and effective use; the setup owner for installation/configuration/readiness mutation.
