...
- **Missing evidence/tool capability** — `iwadi` for substantial current research; `irinse` for companion-tool choice and effective use; `qp-setup` for installation, configuration, authentication, integration, or readiness mutation.
