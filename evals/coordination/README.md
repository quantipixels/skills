...
| Does delegation respect actual host limits? | [C14](actors/C14-codex-profile.md) | Admission decisions versus resolved settings; no-worker and unavailable-capability controls. |
