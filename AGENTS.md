...
Keep `skills/alarina/references/terms.md` current when adding, renaming, or retiring a Yorùbá-named command or agent. Record the marked form, plain meaning, exact identifier, and how that meaning fits the responsibility when it helps a reader choose or understand the method. Verify uncertain forms before adding them; distinguish a project name from a language-wide standard. Update command descriptions and links with the same change.
