...
| `pare` | `audit` reviews all subsystems read-only; `review` inspects one candidate; `clean` removes proved unnecessary implementation or tests; `deep-clean` performs explicitly authorized aggressive test deletion |
