...
When delivery coordination or decomposition can affect planning readiness, read [delivery tracking](../../engineering/delivery/delivery-tracking.md) before declaring `Planned`; loading it does not authorize delivery.
