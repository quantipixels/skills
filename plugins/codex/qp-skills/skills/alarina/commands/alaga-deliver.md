...
When adding or changing tests, read [test quality](../references/alaga/test-suite-improvement.md#behavioral-test-principles). For an accepted improvement to an existing suite, also apply that reference's suite-improvement procedure. Keep independent proof judgment with [atunwo](atunwo.md); Alága owns the resulting changes and verification.
