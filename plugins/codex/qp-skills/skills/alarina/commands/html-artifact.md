...
Read the current source and identify the reader's task, useful result, required coverage and material limits. Organize around that task rather than reproducing source headings. Use [fihanmi](fihanmi.md) when composition is unsettled and [oro-eniyan](oro-eniyan.md) for substantial prose work; write incidental headings and faithful short summaries directly.
...
- [view control](../references/html-artifact/assets/view-control.html): details, aligned comparisons or finite steps;
- [collection filter](../references/html-artifact/assets/collection-filter-control.html): category/text filtering with count, reset and empty state;
- [carousel](../references/html-artifact/assets/carousel-control.html): sequential visual collections;
- [report control](../references/html-artifact/assets/report-control.html): reveal fragment targets and expand required print content;
- [Mermaid renderer](../references/html-artifact/assets/renderer-control.html): conditional diagram rendering with source and explanation fallback.
...
Read [code-change review](../references/html-artifact/code-change-review.md) for exact patch views, or [living and live views](../references/html-artifact/living-and-live.md) when updates arrive while the document is open.
