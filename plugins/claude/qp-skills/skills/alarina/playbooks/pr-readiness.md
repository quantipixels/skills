...
2. For description work, return or update the reviewer brief at that stopping point. For publication, verify the candidate, commit and push only the scoped authorized work, then read back the provider state.
