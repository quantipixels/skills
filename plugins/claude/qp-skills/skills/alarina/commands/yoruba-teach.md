...
Use [research](iwadi.md) for substantial unresolved source questions. Independent source checks may be delegated when useful; verify decisive source locators, marked forms and uncertainty before teaching. A lesson does not require terminology approval or a glossary record and does not authorize durable writes. Finish with the requested teaching result, feedback and any material uncertainty.
