...
- coding-agent/session/rollout → [agent session](../references/ayewo-igba-ise/agent-session.md);
- bounded multi-session corpus → [corpus analysis](../references/ayewo-igba-ise/corpus-analysis.md);
- reusable patterns or lessons from generated artifacts and their producing history → [artifact pattern mining](../references/ayewo-igba-ise/artifact-pattern-mining.md).
...
Use [alaga-diagnose](alaga-diagnose.md) when a missing causal diagnosis materially changes the postmortem. Otherwise proceed with the evidence and its uncertainty.
