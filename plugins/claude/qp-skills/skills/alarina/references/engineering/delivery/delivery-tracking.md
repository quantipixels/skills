...
Use [delivery decomposition](../../../commands/seda-tickets.md) with the settled plan and governing behavior contract.
...
Use [alaga-deliver](../../../commands/alaga-deliver.md) as the builder under the main skill’s delivery seam. Track its candidate, acceptance evidence, blockers, and scope effects; keep implementation, test execution, and coding corrections with Alága.
...
When drift is material, replan from the changed scope and constraints. Use [architect-design](../../../commands/architect-design.md) for structural decisions or [atunwo](../../../commands/atunwo.md) for a code assessment with a simplification focus. Supply the bounded candidate/system, intended delivery shape, observed drift, and current evidence; review depth belongs to [atunwo](../../../commands/atunwo.md) unless explicitly set. Consume its findings, proof gaps, and retained contracts when replanning; recommendations alone do not authorize implementation or prove delivery complete.
