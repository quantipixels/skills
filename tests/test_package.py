...
class PackageTests(unittest.TestCase):
    ...
    def test_active_evaluation_links_are_checked(self):
        self.write("evals/README.md", "[missing](missing.md)\n")
        self.rejected("missing link target")

    def test_historical_links_do_not_claim_current_routes(self):
        self.write("evals/engineering/observations/past.md", "[old](removed-at-new-revision.md)\n")
        self.assertEqual([], package.check(self.root))
